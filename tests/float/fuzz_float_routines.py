...
Examples:
  python3 tests/float/fuzz_float_routines.py -n 5000 --seed 1
  python3 tests/float/fuzz_float_routines.py --routine __fmul,__fdiv -n 2000
"""
...
def output_matches(got: str, err: str, case: ft.Case) -> bool:
    """Same acceptance as tests/float/run_float_tests.py main(), plus float equality for four words.
